...
permalink: /snake
---
In order to restart please reload page
...
/*formatting*/
    ...
    h2 {
        background: linear-gradient(135deg, #7ec8e3, #6a85b6, #89cff0, #6495ed, #4682b4, #1e90ff, #00bfff);
...
snake_speed is the snake speed, food is where the food is, score is the current score*/
        ...
        const activeDot = (x, y, color = '#10DEDA') => {
            ctx.fillStyle = color;
        ...
        const mainLoop = () => {
            ...
            snake.forEach((segment, index) => activeDot(segment.x, segment.y, index === 0 ? '#108FDE' : '#1028DE'));
